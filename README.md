...
6. **`research/06_official_discord_updates.md`** — July 10 organizer notice (verified July 11): current At-Home/Kaggle/Yandex links, Team Challenge access, appeals route, July 22 meeting, and source-safety notes.
...
- [Official 2026 Contest Rules page](https://ioai-official.org/republic-of-kazakhstan/2026-contest-rules/) — current rules, Technical Appendix, and syllabus
- [Official 2026 At-Home tasks](https://github.com/IOAI-official/IOAI-2026)
- [IOAI Official Discord `#home-task`](https://discord.com/channels/1271542282142748774/1520997400364454090) — fast updates; verify peer claims before acting
